...
export function validateInput(inputFile: FileList): ErrorCode {
    if (inputFile === null) {
...
export function readXLSXFile(file: File): Promise<XLSX.WorkBook> {
    return new Promise((resolve, _reject) => {
...
export function renderXLSXSheetToJson(sheet : XLSX.Sheet): any[]{
